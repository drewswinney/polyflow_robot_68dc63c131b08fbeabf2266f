...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "68dc63c131b08fbeabf2266f";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  systemd.services.polyflow_startup = {
    ...
    serviceConfig = {
      ...
      DIRECTORY="/home/${user}/polyflow_robot_68dc63c131b08fbeabf2266f"
      if [[ -d "$DIRECTORY" ]];
        then
          cd "$DIRECTORY"
          ...
          ${pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_68dc63c131b08fbeabf2266f.git
          chown -R ${user}:users /home/${user}/polyflow_robot_68dc63c131b08fbeabf2266f
          
          cd /home/${user}/polyflow_robot_68dc63c131b08fbeabf2266f/workspace/src/webrtc
          ${pkgs.python3Packages.pip}/bin/pip install -r requirements.txt

          cd /home/${user}/polyflow_robot_68dc63c131b08fbeabf2266f/workspace
